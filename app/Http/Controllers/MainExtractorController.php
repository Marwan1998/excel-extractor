...
class MainExtractorController extends Controller
{
    public function runDrilling()
    {
        ...
        $SOC_fileNames = [
            [
                'name' => 'app/new/SOC DAILY DRLG & WO REPORT_APR-03-2026...docx',
                'date' => '04/03/2026',
            ],
            [
                'name' => 'app/new/SOC DAILY DRLG & WO REPORT_APR-04-2026...docx',
                'date' => '04/04/2026',
            ],
            [
                'name' => 'app/new/SOC DAILY DRLG & WO REPORT_APR-05-2026.docx',
                'date' => '04/05/2026',
            ],
        ...
        $AGOCO_fileNames = [
            ...
            [
                'name' => 'app/new/03-04-2026.pdf',
                'date' => '04/03/2026',
            ],
            [
                'name' => 'app/new/04-04-2026.pdf',
                'date' => '04/04/2026',
            ],
            [
                'name' => 'app/new/05-04-2026.pdf',
                'date' => '04/05/2026',
            ],
    ...
    public function runWorkover()
    {
        ...
        $SOC_fileNames = [
            // [
            //     'name' => 'app/SOC DAILY DRLG & WO REPORT_APR-01-2026.docx',
            //     'date' => '04/01/2026',
            // ],
            // [
            //     'name' => 'app/SOC DAILY DRLG & WO REPORT_APR-02-2026.docx',
            //     'date' => '04/02/2026',
            // ],
        ...
        $AGOCO_fileNames = [
            ...
            [
                'name' => 'app/workover/AGOCO WORKOVER REPORTS 01-01-2025.pdf',
                'date' => '01/01/2026',
            ],
            [
                'name' => 'app/workover/AGOCO WORKOVER REPORTS 02-01-2026.pdf',
                'date' => '01/02/2026',
            ],
            [
                'name' => 'app/workover/AGOCO WORKOVER REPORTS 03-01-2026.pdf',
                'date' => '01/03/2026',
            ],
        ...
        // $extractor = new AGOCOWellExtractorWorkover();
        // $data = $extractor->extract(storage_path('app/workover/AGOCO WORKOVER REPORTS 01-01-2025.pdf'));
        // return($data);
